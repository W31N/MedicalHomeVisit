...
import com.example.medicalhomevisit.domain.model.UserRole // Для маппинга, если нужно
import com.example.medicalhomevisit.data.remote.dto.AdminPatientRegistrationDto // DTO для отправки на бэкенд
